    ...
    <div class="fr-step" id="frStep7">
      ...
      <ul class="fr-info-list">
        <li>
          ...
          <div>Na próxima etapa, você realizará uma <strong>verificação facial</strong> com o Frame Authentic para confirmar sua identidade de forma segura e criptografada.</div>
        </li>
        <li>
