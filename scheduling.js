...
<div class="fr-wrap">
  <div class="fr-card" id="frCard">
    ...
    <div class="fr-step" id="frStepMessage">
      ...
      <p class="fr-sub">Opcional — envie uma mensagem e preferências para a modelo antes do encontro.</p>

      <div class="fr-field">
        <label class="fr-label" for="frMsgTextarea">Sua mensagem</label>
        <textarea class="fr-msg-textarea" id="frMsgTextarea" maxlength="200" placeholder="Ex: Oi linda! Mal posso esperar para te conhecer…" oninput="frMsgCounter(this)"></textarea>
