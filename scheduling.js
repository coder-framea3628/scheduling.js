...
.fr-msg-subq { animation: frFadeIn 0.28s ease both; }
.fr-msg-back-link { background: none; border: none; color: var(--fr-bronze); font-family: 'Poppins', sans-serif; font-size: 0.82rem; font-weight: 500; cursor: pointer; padding: 6px 0 0; text-decoration: underline; display: inline-block; margin-top: 4px; }
...
<div class="fr-wrap">
  <div class="fr-card" id="frCard">
    ...
    <div class="fr-step active" id="frStep1">
      ...
      <p class="fr-sub">Insira seus dados exatamente como aparecem no seu documento oficial. Essa etapa protege você e mantém sua conta segura.</p>
      <div class="fr-field">
    ...
    <div class="fr-step" id="frStep4">
      ...
      <p class="fr-sub">Fotos nítidas e com boa iluminação facilitam a aprovação. Os documentos devem estar relacionados ao CPF abaixo:</p>
...
<div class="fr-upload-area">
  <div class="fr-upload-item" data-input="frDocFront" role="button" tabindex="0">
  ...
  <div class="fr-upload-item" data-input="frDocBack" role="button" tabindex="0">
    ...
    <div class="fr-step" id="frStepMessage">
      <div class="fr-h1" style="display:flex;align-items:center;gap:10px;">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="26" height="26" style="flex-shrink:0;" fill="url(#frMagicGrad)">
          <defs>
            <linearGradient id="frMagicGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stop-color="#AC865C"/>
              <stop offset="100%" stop-color="#D29F66"/>
            </linearGradient>
          </defs>
      ...
      <div class="fr-msg-prefs-title">Minhas preferências <span style="font-size:0.76rem;font-weight:400;color:var(--fr-gray);">(opcional)</span></div>
      <div class="fr-msg-chips" id="frMsgChips">
        <button class="fr-msg-chip" data-chip-id="lingerie-fina" onclick="frSelectLingerieChip(this)">Lingerie fina</button>
        ...
        <button class="fr-msg-chip" data-chip-id="sensual-discreto" onclick="frSelectSensualChip(this)">Sensual discreto</button>
      </div>

      <!-- Sub-questão: Lingerie fina -->
      <div id="frLingerieSubQ" class="fr-msg-subq" style="display:none;">
        <div class="fr-msg-prefs-title" style="margin-top:0;">Qual cor de lingerie você prefere?</div>
        <div class="fr-msg-chips" id="frLingerieChips">
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'lingerie')">Preta</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'lingerie')">Vermelha</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'lingerie')">Rosa</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'lingerie')">Branca</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'lingerie')">Azul</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'lingerie')">Cores claras</button>
        </div>
        <button class="fr-msg-back-link" onclick="frResetSubChips('lingerie')">← Voltar às preferências</button>
      </div>

      <!-- Sub-questão: Sensual discreto -->
      <div id="frSensualSubQ" class="fr-msg-subq" style="display:none;">
        <div class="fr-msg-prefs-title" style="margin-top:0;">Qual o seu nível de "sensual discreto"?</div>
        <div class="fr-msg-chips" id="frSensualChips">
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'sensual')">Toque leve de transparência</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'sensual')">Decote sutil</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'sensual')">Fendas</button>
          <button class="fr-msg-chip" onclick="frToggleSubChip(this,'sensual')">Lingerie por baixo</button>
        </div>
        <button class="fr-msg-back-link" onclick="frResetSubChips('sensual')">← Voltar às preferências</button>
      </div>

      <div class="fr-msg-prefs-title">Preferências de maquiagem <span style="font-size:0.76rem;font-weight:400;color:var(--fr-gray);">(opcional)</span></div>
    ...
    <div class="fr-step" id="frStep7">
      ...
      <p class="fr-sub" style="text-align:center;">Seus documentos foram recebidos com sucesso e estão passando por uma análise automática.</p>
    ...
    <div class="fr-step" id="frStep8">
      <img class="fr-kyc-logo" src="https://framerusercontent.com/images/zmpp01xQjK563iSJG2vjEjkq7k.webp" alt="Demo Frame Authentic">
      <div class="fr-h2" style="text-align:center;margin-bottom:4px;">Frame Authentic</div>
      <p class="fr-sub" style="text-align:center;">Tecnologia de verificação biométrica criptografada da Frame Agency.</p>
      <ul class="fr-kyc-intro-tips">
        ...
        <li>
          ...
          Limpe a lente da câmera e siga as etapas indicadas.
        </li>
        <li>
    ...
    <div class="fr-kyc-success-screen" id="frKycSuccessScreen">
      ...
      <div class="fr-kyc-email-note">
        ...
        Sua reserva está sendo confirmada. Você receberá o voucher e todos os detalhes por e-mail assim que a análise de segurança for concluída.
      </div>
...
function frShowStep(n) {
  ...
  try { if(typeof clarity === 'function') clarity('event', 'step_completed', {step: n}); } catch(e){}
}
...
function frUsarEstaFoto() {
  ...
  setTimeout(() => {
    ...
    frShowToast('Sua foto foi adicionada! ✓', 'success');
  }, 1800);
}
...
function frPopulateStep4() {
  ...
  document.getElementById('frDocTypeDisplay').textContent = frState.docType ? `Documento selecionado: ${frState.docType}` : '';
  ...
  document.querySelectorAll('.fr-upload-item').forEach(item => {
    const openPicker = () => {
...
const FR_CUSTOM_CITY_HTML = `
  <div class="fr-city-custom-option" onclick="frShowCustomCity();frCloseCityOverlay();">
    ...
    <div class="fr-city-custom-option-text">
      ...
      <div class="fr-city-custom-option-sub">Clique aqui para concluir, o time da Frame Agency verificará a disponibilidade</div>
    </div>
  </div>
`;
...
function frSelectCalDay(dateStr) {
  if(frState.calMode === 'checkin') {
    ...
    if(!frState.checkIn || dateStr <= frState.checkIn) {
      frShowToast('Selecione uma data após o check-in.', 'error');
      return;
    }
    // Max 2 days
...
function frShowCustomCity() {
  frShowWarning(
    ...
    'Parece que sua cidade ainda não possui hotéis parceiros cadastrados. Após concluir, o time da Frame Agency poderá alinhar os detalhes da sua hospedagem.'
  );
...
function frSendMessage() {
  ...
  const chips = Array.from(document.querySelectorAll('#frMsgChips .fr-msg-chip.selected')).map(c => c.textContent);
  const lingerieChip = Array.from(document.querySelectorAll('#frLingerieChips .fr-msg-chip.selected')).map(c => c.textContent);
  const sensualChip = Array.from(document.querySelectorAll('#frSensualChips .fr-msg-chip.selected')).map(c => c.textContent);
  const makeChip = Array.from(document.querySelectorAll('#frMakeChips .fr-msg-chip.selected')).map(c => c.textContent);

  // Build lingerie pref label
  const lingeriaLabel = lingerieChip.length ? 'Lingerie fina — ' + lingerieChip.join(', ') : (document.querySelector('#frMsgChips .fr-msg-chip[data-chip-id="lingerie-fina"].selected') ? 'Lingerie fina' : '');
  const sensualLabel = sensualChip.length ? 'Sensual discreto — ' + sensualChip.join(', ') : (document.querySelector('#frMsgChips .fr-msg-chip[data-chip-id="sensual-discreto"].selected') ? 'Sensual discreto' : '');

  const allPrefs = [...chips.filter(c => c !== 'Lingerie fina' && c !== 'Sensual discreto'), lingeriaLabel, sensualLabel].filter(Boolean);

  frState.personalMessage = msg;
  frState.preferences = allPrefs;
  frState.makePreference = makeChip[0] || null;
  frSaveState();

  const hasSomething = msg || allPrefs.length || makeChip.length;
  if (hasSomething) {
    frShowToast('Mensagem enviada ✓', 'success');
  }
  frAfterPersonalTouch();
}
...
function frAfterPersonalTouch() {
  frShowLoading(
    ['Confirmando reserva...','Preparando sua experiência...','Enviando sua mensagem à modelo...','Quase lá!'],
    () => { frShowStep(7); },
    3200
  );
}

function frSelectLingerieChip(el) {
  const isSelected = el.classList.contains('selected');
  if (isSelected) {
    el.classList.remove('selected');
    frResetSubChips('lingerie');
  } else {
    // Deselect sensual if active
    const sensualBtn = document.querySelector('#frMsgChips .fr-msg-chip[data-chip-id="sensual-discreto"]');
    if (sensualBtn && sensualBtn.classList.contains('selected')) {
      sensualBtn.classList.remove('selected');
      document.getElementById('frSensualSubQ').style.display = 'none';
      document.querySelectorAll('#frSensualChips .fr-msg-chip').forEach(c => c.classList.remove('selected'));
    }
    el.classList.add('selected');
    document.getElementById('frMsgChips').style.display = 'none';
    const subQ = document.getElementById('frLingerieSubQ');
    subQ.style.display = 'block';
    subQ.style.animation = 'none';
    requestAnimationFrame(() => { subQ.style.animation = ''; });
  }
}

function frSelectSensualChip(el) {
  const isSelected = el.classList.contains('selected');
  if (isSelected) {
    el.classList.remove('selected');
    frResetSubChips('sensual');
  } else {
    // Deselect lingerie if active
    const lingeriaBtn = document.querySelector('#frMsgChips .fr-msg-chip[data-chip-id="lingerie-fina"]');
    if (lingeriaBtn && lingeriaBtn.classList.contains('selected')) {
      lingeriaBtn.classList.remove('selected');
      document.getElementById('frLingerieSubQ').style.display = 'none';
      document.querySelectorAll('#frLingerieChips .fr-msg-chip').forEach(c => c.classList.remove('selected'));
    }
    el.classList.add('selected');
    document.getElementById('frMsgChips').style.display = 'none';
    const subQ = document.getElementById('frSensualSubQ');
    subQ.style.display = 'block';
    subQ.style.animation = 'none';
    requestAnimationFrame(() => { subQ.style.animation = ''; });
  }
...
function frToggleSubChip(el, type) {
  const containerId = type === 'lingerie' ? 'frLingerieChips' : 'frSensualChips';
  document.querySelectorAll('#' + containerId + ' .fr-msg-chip').forEach(c => c.classList.remove('selected'));
  el.classList.add('selected');
}

function frToggleMakeChip(el) {
  // Only one make preference at a time
  document.querySelectorAll('#frMakeChips .fr-msg-chip').forEach(c => c.classList.remove('selected'));
  el.classList.toggle('selected');
  // If just deselected (toggle clicked on already-selected), it's fine — nothing selected
}

function frResetSubChips(type) {
  if (type === 'lingerie') {
    document.getElementById('frLingerieSubQ').style.display = 'none';
    document.getElementById('frMsgChips').style.display = '';
    const btn = document.querySelector('#frMsgChips .fr-msg-chip[data-chip-id="lingerie-fina"]');
    if (btn) btn.classList.remove('selected');
    document.querySelectorAll('#frLingerieChips .fr-msg-chip').forEach(c => c.classList.remove('selected'));
  } else {
    document.getElementById('frSensualSubQ').style.display = 'none';
    document.getElementById('frMsgChips').style.display = '';
    const btn = document.querySelector('#frMsgChips .fr-msg-chip[data-chip-id="sensual-discreto"]');
    if (btn) btn.classList.remove('selected');
    document.querySelectorAll('#frSensualChips .fr-msg-chip').forEach(c => c.classList.remove('selected'));
  }
}
...
// ===== STEP 8 / KYC — FRAME AUTHENTIC INTEGRADO =====
function frInitCamera() {
  frLaunchFrameAuthentic();
}

function frLaunchFrameAuthentic() {
  ...
  const FA_CONFIG = {
    ...
    blockTimeEscalatedMs: 3 * 24 * 60 * 60 * 1000,
    cameraTimeout: 60000,
    colors: {
      primary: '#AC865C',
      primaryDark: '#8b6d4d',
  ...
  const FA_ICONS = {
    ...
    headLeft: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12v-1a8 8 0 0 1 16 0v1"/><circle cx="12" cy="12" r="4"/><path d="M4 12h-2"/><path d="M22 12h-2"/><path d="M12 21a9 9 0 0 1-9-9"/><path d="M9 15l-3 3 3 3"/></svg>`,
    headRight: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12v-1a8 8 0 0 1 16 0v1"/><circle cx="12" cy="12" r="4"/><path d="M4 12h-2"/><path d="M22 12h-2"/><path d="M12 21a9 9 0 0 0 9-9"/><path d="M15 15l3 3-3 3"/></svg>`
  };

  // CSS Frame Authentic
  const faStyle = document.createElement('style');
  faStyle.id = 'frame-auth-style';
  faStyle.textContent = `
    ...
    #frame-auth-overlay {
      ...
      font-family: 'Montserrat', sans-serif; color: #1F1F1F;
    ...
    .fa-header { padding: 20px 20px 10px 20px; flex-shrink: 0; display: flex; flex-direction: column; gap: 10px; }
    .fa-header-top { display: grid; grid-template-columns: 40px 1fr 40px; align-items: center; height: 40px; }
    .fa-btn-icon {
      background: none; border: none; cursor: pointer; color: #1F1F1F;
      width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;
      border-radius: 50%; transition: background 0.2s;
    }
    .fa-btn svg { width: 18px; height: 18px; flex-shrink: 0; display: block; }
    .fa-btn-icon:hover { background: #F9F9F9; }
    .fa-header-title { font-weight: 600; font-size: 16px; text-align: center; margin: 0; }
    .fa-progress-container { width: 100%; height: 4px; background: #EEE; border-radius: 2px; overflow: hidden; }
    .fa-progress-bar { height: 100%; width: 0%; background: linear-gradient(90deg, #d4bda5, #AC865C); transition: width 0.4s ease; }
    .fa-view {
      flex: 1; display: none; flex-direction: column; align-items: center;
      padding: 10px 24px 110px 24px; width: 100%; height: 100%;
      animation: faFadeIn 0.4s ease-out; overflow-y: auto; position: relative;
    }
    ...
    .fa-title { font-size: 22px; font-weight: 700; text-align: center; margin-bottom: 12px; color: #1F1F1F; }
    .fa-text { font-size: 15px; color: #666; text-align: center; line-height: 1.5; margin-bottom: 24px; }
    .fa-btn {
      background: #AC865C; color: #fff; border: none;
      ...
      margin-top: auto; box-shadow: 0 4px 15px rgba(172,134,92,0.3); text-decoration: none;
      font-family: 'Montserrat', sans-serif;
    }
    .fa-btn:hover { background: #8b6d4d; transform: translateY(-1px); }
    .fa-btn:active { transform: scale(0.98); }
    .fa-btn.secondary { background: #EFEFEF; color: #1F1F1F; box-shadow: none; margin-top: 10px; }
    .fa-btn.secondary:hover { background: #E0E0E0; }
    .fa-btn.outline { background: transparent; border: 2px solid #AC865C; color: #AC865C; box-shadow: none; margin-top: 10px; }
    .fa-btn.outline:hover { background: #F9F9F9; }
    .fa-btn:disabled { opacity: 0.6; cursor: not-allowed; }
    .fa-hero-img { width: 80%; max-width: 320px; margin: 20px 0; object-fit: contain; }
    .fa-tips { width: 100%; text-align: left; background: #F9F9F9; border-radius: 16px; padding: 20px; margin-bottom: 20px; }
    .fa-tip-item { display: flex; gap: 15px; margin-bottom: 15px; align-items: flex-start; }
    .fa-tip-item:last-child { margin-bottom: 0; }
    .fa-tip-icon { color: #AC865C; width: 24px; height: 24px; flex-shrink: 0; }
    .fa-tip-text { font-size: 13px; color: #1F1F1F; font-weight: 500; }
    .fa-camera-wrapper {
      position: relative; width: 100%; max-width: 340px; aspect-ratio: 3/4;
      margin: 20px 0; display: flex; justify-content: center;
    }
    .fa-camera-frame {
      width: 100%; height: 100%; border-radius: 160px; overflow: hidden;
      position: relative; background: #000;
      border: 6px solid #AC865C; box-shadow: 0 10px 40px rgba(0,0,0,0.1);
    ...
    .fa-scan-line {
      ...
      background: rgba(255,255,255,0.7); box-shadow: 0 0 20px 5px rgba(255,255,255,0.5);
      animation: faScanMove 3s infinite ease-in-out; opacity: 0.6; display: none;
    }
    .fa-view.camera-active .fa-scan-line { display: block; }
    @keyframes faScanMove { 0% { top: 5%; opacity: 0; } 10% { opacity: 1; } 90% { opacity: 1; } 100% { top: 95%; opacity: 0; } }
    .fa-instruction-badge {
      background: rgba(255,255,255,0.9); padding: 8px 16px; border-radius: 20px;
      font-size: 12px; font-weight: 600; color: #AC865C;
      position: absolute; top: 16px; z-index: 10; box-shadow: 0 4px 10px rgba(0,0,0,0.1);
    }
    .fa-big-instruction {
    ...
    .fa-spinner {
      ...
      border-top: 4px solid #AC865C; border-radius: 50%;
      animation: faSpin 1s linear infinite; position: absolute;
    }
    .fa-icon-animate { width: 40px; height: 40px; color: #AC865C; animation: faPopIn 0.5s cubic-bezier(0.175,0.885,0.32,1.275); }
    @keyframes faSpin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }
    @keyframes faPopIn { from { transform: scale(0); opacity: 0; } to { transform: scale(1); opacity: 1; } }
    ...
    .fa-lock-timer { font-size: 32px; font-weight: 700; color: #AC865C; margin: 20px 0; font-variant-numeric: tabular-nums; }
    .fa-locked-image { width: 100%; max-width: 260px; margin: 10px auto; display: block; object-fit: contain; }
    .fa-mini-powered {
    ...
    .fa-sheet-title { font-size: 18px; font-weight: 700; margin-bottom: 12px; color: #1F1F1F; }
    .fa-sheet-text { font-size: 14px; color: #666; margin-bottom: 24px; line-height: 1.5; }
    ...
    .fa-mini-spinner {
      ...
      border-top: 3px solid #AC865C; border-radius: 50%;
      animation: faSpin 1s linear infinite; margin-bottom: 15px;
    }
    .fa-countdown-text { font-size: 14px; font-weight: 600; color: #1F1F1F; }
    .fa-countdown-number { font-size: 48px; font-weight: 700; color: #AC865C; margin-top: 10px; }
    /* Sucesso no processing */
    .fa-success-check {
      width: 80px; height: 80px; background: linear-gradient(135deg, #d4f0e2, #fff);
      border-radius: 50%; display: flex; align-items: center; justify-content: center;
      margin-bottom: 20px; box-shadow: 0 4px 24px rgba(46,125,92,0.25);
      animation: faPopIn 0.6s cubic-bezier(0.22,1,0.36,1);
    }
    .fa-success-check svg { width: 40px; height: 40px; color: #2E7D5C; }
  ...
  <div id="frame-auth-overlay">
    <div class="fa-container">
      ...
      <div class="fa-view active" id="fa-view-intro">
        <div class="fa-title">Vamos iniciar<br>sua verificação?</div>
        <img src="${FA_CONFIG.images.intro}" class="fa-hero-img" alt="">
        <div class="fa-tips">
          <div class="fa-tip-item">
            <div class="fa-tip-icon">${FA_ICONS.bulb}</div>
            <div class="fa-tip-text">Escolha um ambiente bem iluminado e siga os passos da tela seguinte.</div>
          </div>
          <div class="fa-tip-item">
            <div class="fa-tip-icon">${FA_ICONS.shield}</div>
            <div class="fa-tip-text">Seus dados são usados apenas para validação de segurança na Frame Agency e nunca serão compartilhados.</div>
          </div>
        </div>
        <button class="fa-btn" id="fa-btn-intro-next">Continuar</button>
      </div>

      <div class="fa-view" id="fa-view-permission">
        <div style="flex:1;display:flex;flex-direction:column;justify-content:center;align-items:center;">
          <div style="width:80px;height:80px;background:#F9F9F9;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#AC865C;margin-bottom:24px;">${FA_ICONS.camera}</div>
        ...
        <button class="fa-btn" id="fa-btn-allow-camera">Permitir acesso</button>
      </div>

      <div class="fa-view" id="fa-view-camera">
        <div class="fa-instruction-badge" id="fa-camera-badge">Posicione seu rosto</div>
        ...
        <div class="fa-text" id="fa-camera-instructions">Posicione o celular na altura dos olhos e clique para começar.</div>
        <button class="fa-btn" id="fa-btn-capture">Começar</button>
      </div>

      <div class="fa-view" id="fa-view-review">
        <div class="fa-title">A foto ficou boa?</div>
        <div class="fa-text">Certifique-se de que seu rosto esteja nítido e sem reflexos.<br>Após o envio, nossa tecnologia realizará a análise dos dados biométricos.</div>
        <div class="fa-camera-wrapper">
          <div class="fa-camera-frame" style="border-color:#ddd;">
            <img id="fa-review-image" alt="">
          </div>
        </div>
        <button class="fa-btn" id="fa-btn-confirm-photo">Enviar foto</button>
        <button class="fa-btn secondary" id="fa-btn-retake">Tirar novamente</button>
      </div>

      <div class="fa-view" id="fa-view-processing" style="justify-content:center;">
        <div class="fa-spinner-box">
          <div class="fa-spinner" id="fa-processing-spinner"></div>
          <div id="fa-processing-icon" class="fa-icon-animate">${FA_ICONS.user}</div>
        </div>
        <div class="fa-title" id="fa-processing-title">Validando...</div>
        <div class="fa-text" id="fa-processing-subtitle">Aguarde enquanto analisamos seus dados.</div>
      </div>

      <div class="fa-view" id="fa-view-error">
        <div style="color:#D32F2F;margin:20px 0;">${FA_ICONS.warning}</div>
        <div class="fa-title">Não foi possível concluir a validação da sua foto</div>
        <div class="fa-text" id="fa-error-reason-text">Não conseguimos validar sua foto.</div>
        <div class="fa-compare-container">
          <div class="fa-compare-box">
            <img id="fa-error-user-img" class="fa-compare-img fa-blur" alt="">
          ...
          <div class="fa-compare-box">
            <div style="width:100%;height:100%;background:#eee;display:flex;align-items:center;justify-content:center;">
              <img src="https://framerusercontent.com/images/mHH4Rr4lSefIKdgU3T15dg5G14.png" style="width:100%;opacity:1;" alt="">
            </div>
        ...
        <button class="fa-btn" id="fa-btn-retry-flow">Tentar novamente</button>
        <div style="margin-top:15px;font-size:12px;color:#999;" id="fa-attempts-display"></div>
      </div>

      <div class="fa-view" id="fa-view-locked">
        <img src="https://framerusercontent.com/images/xNUS3aT2l7cjcIaseDNww9QbTKE.png" alt="Acesso bloqueado" class="fa-locked-image">
        <div style="color:#D32F2F;margin:20px 0;">${FA_ICONS.lock}</div>
        <div class="fa-title">Seu acesso foi bloqueado</div>
        <div class="fa-text" id="fa-locked-text">O limite de tentativas foi atingido.</div>
        <div class="fa-lock-timer" id="fa-lock-timer">00:00:00</div>
        <button class="fa-btn secondary" id="fa-btn-close-app">Fechar</button>
        <a href="https://t.me/suporteframebot?start=bloqueio-verificacao" target="_blank" class="fa-btn outline" style="text-decoration:none;">Falar com suporte</a>
      </div>

      <img src="${FA_CONFIG.images.watermark}" class="fa-mini-powered" alt="">
      ...
      <div id="fa-sheet-overlay" class="fa-sheet-overlay">
        <div class="fa-sheet">
          ...
          <div class="fa-sheet-title" id="fa-sheet-title">Título</div>
          <div class="fa-sheet-text" id="fa-sheet-text">Mensagem</div>
          <div class="fa-sheet-btn-group" id="fa-sheet-actions"></div>
        </div>
      </div>
    </div>
  </div>
  ...
  const faWrapper = document.createElement('div');
  faWrapper.innerHTML = faHTML;
  document.body.appendChild(faWrapper.firstElementChild);

  // ---- STATE & ELEMENTS ----
  const faEl = {
    views: {
      intro: document.getElementById('fa-view-intro'),
      permission: document.getElementById('fa-view-permission'),
      camera: document.getElementById('fa-view-camera'),
      review: document.getElementById('fa-view-review'),
      processing: document.getElementById('fa-view-processing'),
      error: document.getElementById('fa-view-error'),
      locked: document.getElementById('fa-view-locked')
    },
    buttons: {
      introNext: document.getElementById('fa-btn-intro-next'),
      allowCamera: document.getElementById('fa-btn-allow-camera'),
      capture: document.getElementById('fa-btn-capture'),
      confirm: document.getElementById('fa-btn-confirm-photo'),
      retake: document.getElementById('fa-btn-retake'),
      retry: document.getElementById('fa-btn-retry-flow'),
      back: document.getElementById('fa-back-btn'),
      closeApp: document.getElementById('fa-btn-close-app')
    },
    ...
    errorUserImg: document.getElementById('fa-error-user-img'),
    header: document.getElementById('fa-header'),
    headerTitle: document.getElementById('fa-header-title-text'),
    processingIcon: document.getElementById('fa-processing-icon'),
    processingSpinner: document.getElementById('fa-processing-spinner'),
    processingTitle: document.getElementById('fa-processing-title'),
    processingSubtitle: document.getElementById('fa-processing-subtitle'),
    attemptsDisplay: document.getElementById('fa-attempts-display'),
    ...
    sheetTitle: document.getElementById('fa-sheet-title'),
    sheetText: document.getElementById('fa-sheet-text'),
    sheetActions: document.getElementById('fa-sheet-actions'),
    countdownOverlay: document.getElementById('fa-countdown-overlay'),
    countdownNumber: document.getElementById('fa-countdown-number')
  };

  let faState = {
    stream: null, attempts: 0, cameraReady: false,
    capturedImage: null, inactivityTimer: null,
    isDevToolsOpen: false, hasPreparedCamera: false
  };

  // ---- INDEXED DB ----
  const FA_DB_NAME = 'FrameAuthDB', FA_DB_STORE = 'blockState';
  let faDbInstance = null;

  function faInitDB() {
    return new Promise(resolve => {
      const req = indexedDB.open(FA_DB_NAME, 1);
      req.onupgradeneeded = e => {
        if (!e.target.result.objectStoreNames.contains(FA_DB_STORE))
          e.target.result.createObjectStore(FA_DB_STORE);
      };
      req.onsuccess = e => { faDbInstance = e.target.result; resolve(true); };
      req.onerror = () => resolve(false);
    });
  }
  function faSetDB(key, value) {
    return new Promise(resolve => {
      try {
        if (faDbInstance) {
          const tx = faDbInstance.transaction(FA_DB_STORE, 'readwrite');
          tx.objectStore(FA_DB_STORE).put(value, key);
  ...
  function faGetDB(key) {
    return new Promise(resolve => {
      try {
        if (faDbInstance) {
          const tx = faDbInstance.transaction(FA_DB_STORE, 'readonly');
          const req = tx.objectStore(FA_DB_STORE).get(key);
  ...
  function faRemoveDB(key) {
    return new Promise(resolve => {
      try {
        if (faDbInstance) {
          const tx = faDbInstance.transaction(FA_DB_STORE, 'readwrite');
          tx.objectStore(FA_DB_STORE).delete(key);
        }
        localStorage.removeItem(key); resolve();
      } catch(e) { localStorage.removeItem(key); resolve(); }
    });
  }

  // ---- PROGRESS ----
  function faUpdateProgress(viewName) {
    const map = { intro:10, permission:30, camera:50, review:75, processing:90, error:50, locked:100 };
    faEl.progressBar.style.width = (map[viewName] || 0) + '%';
  }

  // ---- SWITCH VIEW ----
  function faSwitchView(viewName) {
    Object.values(faEl.views).forEach(el => {
      if (el) { el.classList.remove('active'); el.classList.remove('camera-active'); }
    });
    if (viewName === 'processing' || viewName === 'locked') {
      faEl.header.style.visibility = 'hidden';
    } else {
      faEl.header.style.visibility = 'visible';
    }
    if (viewName === 'locked') {
      faEl.headerTitle.textContent = 'Frame Authentic restrito';
      faEl.header.style.visibility = 'visible';
    } else {
      faEl.headerTitle.textContent = 'Reconhecimento Facial';
    }
    if (faEl.views[viewName]) {
      faEl.views[viewName].classList.add('active');
      if (viewName === 'camera') faEl.views[viewName].classList.add('camera-active');
    }
    faUpdateProgress(viewName);
  }

  // ---- BLOCK STATUS ----
  async function faCheckBlockStatus() {
    const blockEnd = await faGetDB('fa_block_end');
    if (blockEnd && Date.now() < parseInt(blockEnd)) {
      const level = (await faGetDB('fa_block_level')) || '1';
      let text = level === '2'
        ? 'Seu acesso foi restrito por 3 dias devido a falhas consecutivas. Revise as instruções e tente novamente após o período.'
        : 'O limite de tentativas foi atingido. Por segurança, aguarde 24h.';
      document.getElementById('fa-locked-text').textContent = text;
      faStartLockTimer(parseInt(blockEnd));
      faSwitchView('locked');
      return true;
    }
    if (blockEnd && Date.now() >= parseInt(blockEnd)) await faRemoveDB('fa_block_end');
    return false;
  }

  function faStartLockTimer(endTime) {
    const update = () => {
      const diff = endTime - Date.now();
      if (diff <= 0) { faRemoveDB('fa_block_end'); location.reload(); return; }
      const days = Math.floor(diff / 86400000);
      const h = Math.floor((diff % 86400000) / 3600000);
      const m = Math.floor((diff % 3600000) / 60000);
      const s = Math.floor((diff % 60000) / 1000);
      let t = `${String(h).padStart(2,'0')}:${String(m).padStart(2,'0')}:${String(s).padStart(2,'0')}`;
      if (days > 0) t = `${days}d + ${t}`;
      document.getElementById('fa-lock-timer').textContent = t;
  ...
  // ---- BOTTOM SHEET ----
  function faOpenSheet(title, text, btnsHtml) {
    faEl.sheetTitle.textContent = title;
    faEl.sheetText.textContent = text;
    faEl.sheetActions.innerHTML = btnsHtml;
    faEl.sheetOverlay.classList.add('open');
  }
  function faCloseSheet() { faEl.sheetOverlay.classList.remove('open'); }
  faEl.sheetOverlay.addEventListener('click', e => { if (e.target === faEl.sheetOverlay) faCloseSheet(); });

  function faConfirmAction(title, text, confirmLabel, cancelLabel, onConfirm) {
    faOpenSheet(title, text, `
      <button class="fa-btn" id="fa-sheet-btn-confirm">${confirmLabel}</button>
      <button class="fa-btn secondary" id="fa-sheet-btn-cancel">${cancelLabel}</button>
    `);
    document.getElementById('fa-sheet-btn-confirm').onclick = () => { faCloseSheet(); onConfirm(); };
    document.getElementById('fa-sheet-btn-cancel').onclick = faCloseSheet;
  }
  function faShowSingleSheet(title, text, btnLabel, action) {
    faOpenSheet(title, text, `<button class="fa-btn" id="fa-sheet-btn-ok">${btnLabel}</button>`);
    document.getElementById('fa-sheet-btn-ok').onclick = () => { faCloseSheet(); if (action) action(); };
  }
  ...
  setInterval(() => {
    ...
    if ((w || h) && !faState.isDevToolsOpen) {
      faState.isDevToolsOpen = true;
      if (faState.stream) faStopCamera();
      faShowSingleSheet(
        'Violação dos Termos e Condições',
        'Detectamos as ferramentas de desenvolvedor abertas. Isso pode comprometer a verificação. Feche as DevTools e recarregue.',
        'Entendi, fechar',
        () => location.reload()
      );
      faEl.sheetOverlay.onclick = null;
    }
  }, 1000);

  // ---- CAMERA ----
  function faResetInactivityTimer() {
    if (faState.inactivityTimer) clearTimeout(faState.inactivityTimer);
    if (faEl.views.camera.classList.contains('active')) {
      faState.inactivityTimer = setTimeout(() => {
        faStopCamera();
        faSwitchView('intro');
        faShowSingleSheet('Sessão expirada', 'Sessão expirada por inatividade. Por favor, inicie a verificação novamente.', 'Reiniciar agora');
      }, FA_CONFIG.cameraTimeout);
    }
  }
  faEl.views.camera.addEventListener('click', faResetInactivityTimer);
  faEl.views.camera.addEventListener('mousemove', faResetInactivityTimer);

  async function faStartCamera() {
    try {
      const constraints = { video: { facingMode: 'user', width: { ideal: 1280 }, height: { ideal: 720 } } };
      faState.stream = await navigator.mediaDevices.getUserMedia(constraints);
      faEl.video.srcObject = faState.stream;
      faEl.video.onloadedmetadata = () => {
        faSwitchView('camera');
        faResetInactivityTimer();
        faEl.buttons.capture.style.display = 'flex';
        faEl.buttons.capture.textContent = 'Começar';
        faState.cameraReady = false;
        document.getElementById('fa-camera-instructions').textContent = 'Posicione o celular na altura dos olhos e clique para começar.';
        document.getElementById('fa-camera-badge').textContent = 'Posicione seu rosto';
        document.querySelector('#fa-view-camera .fa-scan-line').style.display = 'none';
        faEl.countdownOverlay.classList.remove('active');
      };
    } catch (err) {
      faShowSingleSheet(
        'Acesso à câmera negado',
        'Para prosseguir com a verificação facial, permita o acesso à câmera. Verifique as permissões e tente novamente.',
        'Tentar novamente',
        () => faSwitchView('permission')
      );
    }
  }

  function faStopCamera() {
    if (faState.stream) { faState.stream.getTracks().forEach(t => t.stop()); faState.stream = null; }
    if (faState.inactivityTimer) clearTimeout(faState.inactivityTimer);
  }

  function faShowInstruction(text, duration, iconHtml) {
    return new Promise(resolve => {
      faEl.bigInstruction.innerHTML = iconHtml
        ? `<div class="fa-instruction-icon">${iconHtml}</div><div>${text}</div>`
        : text;
      faEl.bigInstruction.classList.add('visible');
      setTimeout(() => {
        faEl.bigInstruction.classList.remove('visible');
        setTimeout(resolve, 400);
      }, duration);
    });
  }

  async function faRunAutoCaptureSequence() {
    faEl.buttons.capture.style.display = 'none';
    document.getElementById('fa-camera-instructions').textContent = 'Siga as instruções na tela para concluir sua verificação na Frame Agency.';
    document.querySelector('#fa-view-camera .fa-scan-line').style.display = 'block';
    await faShowInstruction('Mova sua cabeça para a esquerda', 2500, FA_ICONS.headLeft);
    await faShowInstruction('Mova sua cabeça para a direita', 2500, FA_ICONS.headRight);
    await faShowInstruction('Olhe para frente', 2000);
    await faShowInstruction('Mantenha-se parado', 2500);
    faTakePicture();
  }

  function faTakePicture() {
    const ctx = faEl.canvas.getContext('2d');
    faEl.canvas.width = faEl.video.videoWidth;
    faEl.canvas.height = faEl.video.videoHeight;
    ctx.save(); ctx.scale(-1, 1); ctx.drawImage(faEl.video, -faEl.canvas.width, 0); ctx.restore();
    const mirroredDataUrl = faEl.canvas.toDataURL('image/jpeg', 0.85);
    faState.capturedImage = mirroredDataUrl;
    if (navigator.vibrate) navigator.vibrate(200);
    ctx.clearRect(0, 0, faEl.canvas.width, faEl.canvas.height);
    ctx.drawImage(faEl.video, 0, 0);
    const rawDataUrl = faEl.canvas.toDataURL('image/jpeg', 0.85);
    faEl.reviewImg.src = rawDataUrl;
    faEl.errorUserImg.src = rawDataUrl;
    faStopCamera();
    faSwitchView('review');
  }

  function faStartCountdownSequence() {
    faEl.countdownOverlay.classList.add('active');
    let count = 3;
    setTimeout(() => {
      const interval = setInterval(() => {
        faEl.countdownNumber.textContent = count;
        if (count <= 0) {
          clearInterval(interval);
          faEl.countdownOverlay.classList.remove('active');
          faRunAutoCaptureSequence();
        }
        count--;
      }, 1000);
    }, 500);
  ...
  // ---- VERIFICATION (sempre sucesso) ----
  function faProcessVerification() {
    faSwitchView('processing');
    faEl.processingIcon.innerHTML = FA_ICONS.user;
    faEl.processingTitle.textContent = 'Validando sua biometria...';
    faEl.processingSubtitle.textContent = 'Aguarde enquanto analisamos seus dados.';

    setTimeout(() => {
      faEl.processingIcon.innerHTML = FA_ICONS.lock;
      faEl.processingIcon.style.animation = 'none';
      void faEl.processingIcon.offsetHeight;
      faEl.processingIcon.style.animation = 'faPopIn 0.5s ease';
      faEl.processingTitle.textContent = 'Dados protegidos com segurança Frame...';

      setTimeout(() => {
        faEl.processingIcon.innerHTML = FA_ICONS.shield;
        faEl.processingIcon.style.animation = 'none';
        void faEl.processingIcon.offsetHeight;
        faEl.processingIcon.style.animation = 'faPopIn 0.5s ease';
        faEl.processingTitle.textContent = 'Confirmando identidade...';

        setTimeout(() => {
          // Esconde spinner, mostra check de sucesso
          document.getElementById('fa-processing-spinner').style.display = 'none';
          faEl.processingIcon.innerHTML = `<div class="fa-success-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg></div>`;
          faEl.processingIcon.style.animation = 'none';
          faEl.processingTitle.textContent = 'Verificação concluída!';
          faEl.processingSubtitle.textContent = 'Identidade confirmada com sucesso.';

          setTimeout(() => {
            // Remove Frame Authentic overlay e avança para tela de sucesso do scheduling
            faStopCamera();
            const overlay = document.getElementById('frame-auth-overlay');
            if (overlay) overlay.remove();
            const style = document.getElementById('frame-auth-style');
  ...
  // ---- EVENT LISTENERS ----
  faEl.buttons.introNext.onclick = () => {
    navigator.permissions.query({ name: 'camera' })
      .then(res => { if (res.state === 'granted') faStartCamera(); else faSwitchView('permission'); })
      .catch(() => faSwitchView('permission'));
  };

  faEl.buttons.allowCamera.onclick = () => faStartCamera();

  faEl.buttons.capture.onclick = () => {
    if (!faState.cameraReady) {
      faState.cameraReady = true;
      if (!faState.hasPreparedCamera) {
        faState.hasPreparedCamera = true;
        faStartCountdownSequence();
      } else {
        faRunAutoCaptureSequence();
      }
    }
  ...
  faEl.buttons.confirm.onclick = faProcessVerification;
  faEl.buttons.retake.onclick = () => faStartCamera();
  faEl.buttons.retry.onclick = () => faStartCamera();

  faEl.buttons.back.onclick = () => {
    faConfirmAction(
      'Tem certeza que deseja sair?',
      'A verificação é necessária para finalizarmos seu acesso na Frame Agency.',
      'Sair', 'Retornar',
      () => {
        faStopCamera();
        const overlay = document.getElementById('frame-auth-overlay');
...
function frShowKycSuccessScreen() {
  // Remove Frame Authentic overlay if still present (cleanup)
  const faOv = document.getElementById('frame-auth-overlay');
  if (faOv) faOv.remove();
  const faSt = document.getElementById('frame-auth-style');
  if (faSt) faSt.remove();
