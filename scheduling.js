...
// ===== CONSTANTS =====
const FR_PROHIBITED = ['cu','pau','ppk','papai','daddy','penis','putão','putinha','bctinha','fake','bosta','peitudo','goza','chupa','puta','kids','kid','baby','bebe','cp','porno','estupro','estuprador','buceta','caralho','foder','fode','transar','sexo','bucetinha','roubar','exterminar','cuzinho','chupetinha','viado','baitola','prostituta','do job','pedofilo','bct','nuds','leitada','fetiche','penis','vagina','pepeka','piroca','gozada','pedofilia','violencia','ameaca','drogas','ilegal','merda','porra','otario','idiota','imbecil','retardado','maldito','safado','vadia','piranha','bandido','vagabundo','cristiano ronaldo','safadao','assassino','matar','cocaina','crack','maconha','heroin','lsd','ecstasy','meth','skank','baseado','cheirinho','loló','keta','ketamina','nudes','xvideos','pornhub','xnxx','putaria','safadeza','nóia','noiado','cheiro','pedra','traficante','job','trafico','sequestro','latrocinio','homicidio','suicidio','autolesao','cortar','matar-se','se matar','krl','kct','hehe','haha','kkk','kkkk'];
  ...
  if(!matches.length) {
    results.innerHTML = `
      <div class="fr-city-no-results">
        ...
        <div style="font-weight:600;margin-bottom:6px;">Nenhuma cidade foi encontrada</div>
...
function frShowCustomCity() {
  frShowWarning(
    ...
    'Parece que sua cidade ainda não possui hotéis parceiros cadastrados que atendam aos nossos padrões. Após concluir, entre em contato com nosso suporte para verificarmos opções especiais para você.'
  );
}
