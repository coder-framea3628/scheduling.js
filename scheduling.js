...
document.body.innerHTML = `
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step5" class="step">
      ...
      <div class="comunicado-card">
        <div class="hotel-img-container">
          ...
          <div class="hotel-selo">Comunicado Oficial</div>
        </div>
    ...
    <div id="step6" class="step">
      ...
      <div class="upsell-group" onclick="this.querySelector('input').click()">
  ...
  <div class="help-sheet" id="help-sheet">
    ...
    <ul class="help-list">
      ...
      <li><a href="mailto:contato@frameag.com">Email: contato@frameag.com</a></li>
    </ul>
  </div>
...
function showStep(step) {
  ...
  if (step === 5) {
    ...
    if (selectedHotel) document.getElementById('selected-hotel').textContent = selectedHotel.name;
  } else if (step === 6) {
...
function selectDate(date) {
  ...
  if (checkInDate && checkOutDate) showToast('O horário será alinhado por e-mail');
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('overlay-black').addEventListener('click', () => {
    document.querySelectorAll('.bottom-sheet.show, .payment-popup, .faq-popup, .warning-popup, .blocked-popup').forEach(el => {
      const close = el.querySelector('.close-popup') || el.querySelector('button');
