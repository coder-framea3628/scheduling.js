...
.city-select::before {
  ...
  width: 24px;
  height: 24px;
  background: url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27currentColor%27 stroke-width=%272%27%3E%3Cpath d=%27M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z%27/%3E%3C/svg%3E') no-repeat center / 24px;
  z-index: 1;
}
#city-list {
  position: absolute;
...
.selected-summary {
  ...
  z-index: 1000;
  text-align: center;
  display: block; /* always visible in step5 */
}
.selected-summary p {
  margin-bottom: 8px;
  text-align: center;
...
.calendar-nav {
  display: none; /* removed navigation */
}
.load-more-dates {
  display: none; /* removed load more */
}
.comunicado-card {
  background: var(--input-bg);
  border-radius: 16px;
...
document.body.innerHTML = `
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step1" class="step active">
      ...
      <div class="input-group">
        ...
        <input type="text" id="nome" placeholder="Ex: João da Silva Oliveira" maxlength="100">
        <div class="error-message"></div>
        <div class="tooltip" id="tooltip-nome">Nome completo até 100 caracteres.</div>
      </div>
      <div class="input-group">
        <label for="cpf">CPF</label>
        <input type="text" id="cpf" placeholder="000.000.000-00" inputmode="numeric">
        <div class="error-message"></div>
        <div class="tooltip" id="tooltip-cpf">Dados corretos garantem a não reprovação do agendamento.</div>
      </div>
      <div class="input-group">
        <label for="rua">Rua</label>
        <input type="text" id="rua" placeholder="Ex: Rua das Flores" maxlength="100">
        <div class="error-message"></div>
        <div class="tooltip" id="tooltip-rua">Endereço completo para verificação.</div>
      </div>
      <div class="row">
        <div class="input-group">
          <label for="bairro">Bairro</label>
          <input type="text" id="bairro" placeholder="Ex: Centro" maxlength="100">
          <div class="error-message"></div>
        </div>
        <div class="input-group">
          <label for="numero">Número</label>
          <input type="text" id="numero" placeholder="Ex: 143" inputmode="numeric" maxlength="10">
          <div class="error-message"></div>
        </div>
      </div>
      <div class="row">
        <div class="input-group">
          ...
          <input type="text" id="cidade" placeholder="São Paulo" maxlength="100">
          <div class="error-message"></div>
        </div>
        <div class="input-group">
    ...
    <div id="step2" class="step">
      ...
      <div class="input-group">
        ...
        <input type="text" id="displayName" placeholder="Ex: João Silva" maxlength="100">
        <div class="error-message"></div>
        <div class="tooltip" id="tooltip-displayName">Nome de exibição até 100 caracteres.</div>
      </div>
      <div class="input-group">
    ...
    <div id="step5" class="step">
      <h2 style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Selecione sua hospedagem</h2>
      ...
      <div class="comunicado-card">
        ...
        <div class="hotel-info">
          ...
          <p class="hotel-desc">Digite a cidade onde deseja a realização do seu encontro ou selecione 'Minha cidade não está na lista' e siga os passos na tela.</p>
        </div>
        <div class="hotel-actions">
          <div class="details-link" onclick="document.getElementById('city').focus()">Buscar cidade <svg width="16" height="16" fill="var(--primary-color)"><path d="M4 9h8l-4-4-4 4"/></svg></div>
        </div>
      </div>
      <div class="city-select">
        <input type="text" id="city" placeholder="Buscar cidade...">
      ...
      <div id="hotel-section" style="display: none;">
        <h3 style="font-size: 1rem;">Hotéis parceiros em: </h3>
    ...
    <div id="step6" class="step">
      ...
      <div class="included-badge">✓ TUDO INCLUSO</div>
      ...
      <div class="resumo-card">
        <div class="resumo-item"><span>Data: ${checkInDate ? checkInDate.toLocaleDateString('pt-BR') : ''} - ${checkOutDate ? checkOutDate.toLocaleDateString('pt-BR') : ''}</span><span class="edit-link" onclick="editDates()">Editar</span></div>
      </div>
      ...
      <button class="btn secondary" id="download-pre-reserva">Baixar Pré-Reserva PDF</button>
    </div>
    <div id="step7" class="step">
      <dotlottie-player src="https://lottie.host/a11872ae-9848-45ba-8871-fa870929372e/YWZlUTBnMU.lottie" background="transparent" speed="1" style="width:140px; height:140px; margin:0 auto;" loop autoplay></dotlottie-player>
      <h2>${userData.personal ? userData.personal.nome : ''}, estamos quase finalizando!</h2>
      <p>É importante que você baixe e guarde o arquivo da sua reserva.</p>
      <button class="btn secondary" id="download-pre-reserva-step7">Baixar Pré-Reserva PDF</button>
      <button class="btn" id="continue-to-verification">Continuar</button>
    </div>
  ...
  <div class="date-fullscreen" id="date-fullscreen">
    <div class="progress-bar"><div class="progress-fill"></div></div>
    <h2 style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Selecione a data da experiência</h2>
  ...
  <div class="premium-overlay" id="premium-overlay">
    <div class="premium-content">
      <dotlottie-player src="https://lottie.host/8cbce635-93a8-4ae4-b111-14aa9305a5e3/4MraxyYnP2.lottie" background="transparent" speed="1" style="width:140px; height:140px; margin:0 auto;" loop autoplay></dotlottie-player>
      <h2 style="font-family: Montserrat; font-weight:600; color:#333;">Identificamos sua assinatura Premium.</h2>
      <p style="font-size:14px; color:#333;">Por ser um usuário Premium, você conta com hospedagem inclusa no seu agendamento</p>
      <div class="premium-selo">Cortesia exclusiva da Frame.</div>
      <p>Deseja aproveitar esta oferta?</p>
      <button class="btn" style="background: linear-gradient(to right, var(--primary-color), var(--accent-light));" onclick="closePremiumOverlay(true)">Sim, seguir com a oferta</button>
      <a style="color: #333; cursor:pointer; text-decoration:underline;" onclick="closePremiumOverlay(false)">Seguir sem a oferta</a>
    </div>
  </div>
  ...
  <div class="faq-popup" id="faq-popup">
    ...
    <ul>
      <li><strong>Como cancelar?</strong> Envie email pra contato@frameag.com em até 48h antes da experiência e prosseguimos com o reembolso de 80% do valor.</li>
      <li><strong>O que inclui?</strong> Hospedagem premium durante a experiência, privacidade total e suporte 24h.</li>
      <li><strong>Adicionais do checkout valem a pena?</strong> Sim, os adicionais acrescentam luxos, brinquedos ou vantagens como check-in early e café VIP.</li>
      <li><strong>Verificação facial?</strong> Garante segurança; leva 30s.</li>
    </ul>
...
checkInDate = dates.checkIn ? new Date(dates.checkIn) : null;
checkOutDate = dates.checkOut ? new Date(dates.checkOut) : null;
...
function validateStep(step) {
  ...
  if (step === 1) {
    ...
    if (!nome || nome.split(' ').length < 2 || nome.length > 100) {
      showError('nome', 'Por favor, insira seu nome completo (até 100 caracteres).');
      valid = false;
    }
    ...
    if (!rua || rua.length > 100) {
      showError('rua', 'Informe sua rua (até 100 caracteres).');
      valid = false;
    }
    if (!bairro || bairro.length > 100) {
      showError('bairro', 'Informe seu bairro (até 100 caracteres).');
      valid = false;
    }
    if (!numero) {
    ...
    if (!cidade || cidade.length > 100) {
      showError('cidade', 'Informe sua cidade (até 100 caracteres).');
      valid = false;
    }
    if (!estado) {
    ...
    if (!displayName || displayName.length > 100) {
      showError('displayName', 'Campo obrigatório (até 100 caracteres).');
      valid = false;
    }
    if (!showAge) {
...
function initAutocomplete() {
  ...
  popularCities.forEach(city => {
    ...
    sug.addEventListener('click', () => {
      ...
      document.getElementById('hotel-section').querySelector('h3').textContent = `Hotéis parceiros em: ${city.name}`;
    });
  ...
  input.addEventListener('input', () => {
    ...
    filtered.forEach(c => {
      ...
      option.addEventListener('click', () => {
        ...
        document.getElementById('city-select').style.display = 'none';
        document.getElementById('hotel-section').style.display = 'block';
        document.getElementById('hotel-section').querySelector('h3').textContent = `Hotéis parceiros em: ${c}`;
      });
...
function loadHotels(city) {
  ...
  if (hotels[city]) {
    hotels[city].forEach((hotel, index) => {
      ...
      card.innerHTML = `
        <div class="hotel-img-container">
          <img src="${hotel.profileImg}" class="hotel-img" alt="${hotel.name}" data-src="${hotel.profileImg}" oncontextmenu="return false;" style="user-select: none; -webkit-user-drag: none;">
        ...
        <div class="hotel-info">
          ...
          <p class="hotel-desc" style="user-select: none;">${hotel.desc}</p>
        </div>
        <div class="hotel-actions">
...
function showHotelDetails(city, index) {
  ...
  content.innerHTML = `
    ...
    <div>
      <h3 style="text-align: center; font-size: 1.2rem; font-weight: bold;">${hotel.name}</h3>
      <p style="text-align: left; font-size: 0.9rem;">${hotel.desc}</p>
...
function selectHotel(city, index, btn) {
  ...
  setTimeout(() => {
    ...
    selectedHotel = { ...hotels[city][index], city };
...
function editDates() {
  showCalendar();
  // update dates no loading, back to 6
}
...
function updateUpsell() {
  ...
  if (total > 0) {
    confirmBtn.textContent = 'Pagar agora';
...
confirmBtn.addEventListener('click', () => {
  ...
  document.getElementById('overlay-black').style.display = 'block';
  document.getElementById('go-payment').onclick = () => {
    document.getElementById('loading-overlay').style.display = 'flex';
    document.getElementById('loading-message').textContent = 'Redirecionando…';
    window.open(link, '_blank');
    setTimeout(() => {
      document.getElementById('loading-overlay').style.display = 'none';
      document.getElementById('go-payment').style.display = 'none';
...
function closePremiumOverlay(accept) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('save-dates').addEventListener('click', () => {
    if (checkInDate && checkOutDate) {
      ...
      localStorage.setItem('dates', JSON.stringify({checkIn: checkInDate, checkOut: checkOutDate}));
  ...
  document.getElementById('step4-btn').addEventListener('click', () => { if (validateStep(4)) showLoadingOverlay(['Verificando informações…', 'Analisando seus dados…', 'Tudo certo!'], () => showCalendar()); });
  document.getElementById('step5-btn').addEventListener('click', () => { if (validateStep(5)) showStep(6); });
  document.getElementById('continue-to-verification').addEventListener('click', () => showStep(8));
  document.getElementById('download-pre-reserva').addEventListener('click', generatePDF);
  document.getElementById('download-pre-reserva-step7').addEventListener('click', generatePDF);
  ...
  document.querySelectorAll('.close-popup').forEach(c => c.addEventListener('click', () => {
    c.closest('.bottom-sheet, .popup-overlay, .faq-popup, .payment-popup, .warning-popup').style.display = 'none';
    document.getElementById('overlay-black').style.display = 'none';
  }));
...
function generatePDF() {
  ...
  const doc = new jsPDF();
  // Add custom font here, example:
  // const fontBase64 = 'YOUR_BASE64_HERE'; // Convert Montserrat TTF using jsPDF fontconverter
  // doc.addFileToVFS('Montserrat-Regular.ttf', fontBase64);
  // doc.addFont('Montserrat-Regular.ttf', 'Montserrat', 'normal');
  // doc.setFont('Montserrat');
  doc.setFont('helvetica'); // Default for now
  const hoje = new Date();
  const dia = String(hoje.getDate()).padStart(2, '0');
  const mes = String(hoje.getMonth() + 1).padStart(2, '0');
  const ano = hoje.getFullYear();
  const codigoUnico = Math.floor(Math.random() * 900000) + 100000;
  const codigoReserva = `F-${codigoUnico}-${dia}${mes}${ano}`;
  const nome = userData.personal.nome;
  const cpf = userData.personal.cpf;
  const endereco = `${userData.personal.rua}, ${userData.personal.numero} – ${userData.personal.bairro} – ${userData.personal.cidade} – ${userData.personal.estado}`;
  const checkInStr = checkInDate ? `${String(checkInDate.getDate()).padStart(2, '0')}/${String(checkInDate.getMonth() + 1).padStart(2, '0')}/${checkInDate.getFullYear()}` : '(dia)/(mês)/(ano)';
  const checkOutStr = checkOutDate ? `${String(checkOutDate.getDate()).padStart(2, '0')}/${String(checkOutDate.getMonth() + 1).padStart(2, '0')}/${checkOutDate.getFullYear()}` : '(dia)/(mês)/(ano)';
  const emissao = `${dia} de ${mes} de ${ano}`;
  const pagamentoDate = `${dia} de ${mes} de ${ano}`;
  // Logo
  const logoUrl = 'https://framerusercontent.com/images/2q0L5VgbcB1j70YVtdptjLfg08A.png';
  fetch(logoUrl).then(res => res.blob()).then(blob => {
    const reader = new FileReader();
    reader.readAsDataURL(blob);
    reader.onloadend = () => {
      doc.addImage(reader.result, 'PNG', 150, 10, 80, 0); // Adjust position and size
      // Add texts
      doc.setFontSize(12);
      doc.text('Pré Reserva - Frame Agency', 10, 10);
      doc.text('Número da reserva: ' + codigoReserva, 10, 20);
      doc.text('Data de emissão: ' + emissao, 10, 30);
      doc.text('Frame Tecnologia LTDA', 10, 40);
      doc.text('CNPJ - 38.539.493/0001-05', 10, 50);
      doc.text('Av Brigadeiro Faria Lima', 10, 60);
      doc.text('São Paulo - São Paulo, Brasil', 10, 70);
      doc.text('contato@frameag.com', 10, 80);
      doc.text('Serviço Hoster de Pré Reserva Frame Tecnologia LTDA', 10, 90);
      doc.text('by Booking.com Brasil Servicos de Reserva de Hoteis LTDA', 10, 100);
      doc.text(checkInStr + ' – ' + checkOutStr + '.', 10, 110);
      doc.text('F-' + codigoUnico + '- (número baseado no dia, mês e ano do PDF)', 10, 120);
      doc.text('Subtotal', 10, 130);
      doc.text('Desconto Partner', 10, 140);
      doc.text('Valor devido pelo cliente', 10, 150);
      doc.text('Emitida para:', 10, 160);
      doc.text('(dados do cliente)', 10, 170);
      doc.text(nome, 10, 180);
      doc.text(cpf, 10, 190);
      doc.text(endereco, 10, 200);
      doc.text('Adicione', 10, 210);
      doc.text('1 estádia', 10, 220);
      doc.text('2 hóspedes', 10, 230);
      doc.text('Acessar portal do cliente', 10, 240);
      doc.setTextColor('#9A7A56');
      doc.textWithLink('https://frameag.com/login', 50, 240, { url: 'https://frameag.com/login' });
      doc.setTextColor(0,0,0);
      doc.text('Olá! Essa é uma confirmação da sua Pré Reserva para o serviço de hospedagem da Frame Agency.', 10, 250);
      doc.text('Status e Condições:', 10, 260);
      doc.text('Esta reserva é uma Pré-Reserva e está sujeita à verificação interna da Frame Tecnologia LTDA, incluindo a validação', 10, 270);
      doc.text('de identidade e documentos. A efetivação final da reserva depende da aprovação integral após esta verificação.', 10, 280);
      doc.text('Oferecemos um suporte 24h todos os dias. Fale conosco em: www.frameag.com/contato.', 10, 290);
      doc.setTextColor('#9A7A56');
      doc.textWithLink('www.frameag.com/contato', 10, 300, { url: 'https://frameag.com/contato' });
      doc.setTextColor(0,0,0);
      doc.text('Ou no chat de atendimento no Telegram: https://t.me/suporteframebot?start=fatura-mail', 10, 310);
      doc.setTextColor('#9A7A56');
      doc.textWithLink('https://t.me/suporteframebot?start=fatura-mail', 10, 320, { url: 'https://t.me/suporteframebot?start=fatura-mail' });
      doc.setTextColor(0,0,0);
      doc.text('Atenciosamente,', 10, 330);
      doc.text('Frame Tecnologia LTDA.', 10, 340);
      doc.text('R$ 3740,00', 150, 130);
      doc.text('R$ 3740,00', 150, 140);
      doc.text('R$ 3740,00', 150, 150);
      doc.text('R$ 0,00', 150, 160);
      doc.text('R$ 3740,00 pagos pela empresa em ' + pagamentoDate + '.', 10, 350);
      doc.text('Cancelamento:', 10, 360);
      doc.text('A Frame Tecnologia LTDA se reserva o direito de cancelar unilateralmente esta Pré-Reserva a qualquer momento,', 10, 370);
      doc.text('caso as condições e verificações não sejam atendidas, ou por motivos internos da empresa. O cancelamento não', 10, 380);
      doc.text('gerará ônus ou responsabilidade adicional para a Frame, exceto pela devolução de valores, se aplicável.', 10, 390);
      doc.text('Termos  e Condições:', 10, 400);
      doc.text('Ao baixar e/ou possuir este documento, o Usuário citado neste PDF declara ter lido e concordado integralmente com', 10, 410);
      doc.text('os Termos e Condições Gerais disponíveis em[](https://frameag.com/termos), bem como os Termos do contrato', 10, 420);
      doc.text('assinado digitalmente antes da emissão deste arquivo.', 10, 430);
      doc.setTextColor('#9A7A56');
      doc.textWithLink('https://frameag.com/termos', 10, 440, { url: 'https://frameag.com/termos' });
      doc.setTextColor(0,0,0);
      doc.save(`Pre-Reserva-Frame-${nome}.pdf`);
      showToast('Sua Pré-Reserva foi gerada com sucesso.');
