...
<div class="fr-wrap">
  <div class="fr-card" id="frCard">
    ...
    <div class="fr-step" id="frStep3">
      ...
      <p class="fr-sub" style="text-align:left;">Selecione o documento que você irá enviar na próxima etapa para verificação.</p>
    ...
    <div class="fr-help-body" id="frHelpBody">
      ...
      <div class="fr-help-faq-list">
        <div class="fr-help-faq-item" onclick="frToggleFaq(this)">
          ...
          <div class="fr-help-faq-a">O CPF é necessário para confirmar sua identidade e garantir a segurança de todos os envolvidos no processo. Seus dados são protegidos com criptografia de ponta a ponta.
        ...
        <div class="fr-help-faq-item" onclick="frToggleFaq(this)">
          ...
          <div class="fr-help-faq-a">Sim. Todos os dados são tratados conforme a LGPD e nossa Política de Privacidade. Documentos enviados são deletados automaticamente após a aprovação.
            <button class="fr-help-back-btn" onclick="frCloseHelp(null, true)">Voltar para verificação</button>
          </div>
        </div>
        <div class="fr-help-faq-item" onclick="frToggleFaq(this)">
          ...
          <div class="fr-help-faq-a">A verificação de documentos é parte do processo KYC (Know Your Customer), exigido para garantir a segurança de todas as experiências realizadas via Frame Agency.
            <button class="fr-help-back-btn" onclick="frCloseHelp(null, true)">Voltar para verificação</button>
          </div>
        </div>
        <div class="fr-help-faq-item" onclick="frToggleFaq(this)">
          ...
          <div class="fr-help-faq-a">É nossa tecnologia biométrica que confirma que você é o(a) titular dos dados fornecidos. O processo leva apenas ~15 segundos e utiliza a câmera do seu dispositivo.
            <button class="fr-help-back-btn" onclick="frCloseHelp(null, true)">Voltar para verificação</button>
          </div>
        </div>
        <div class="fr-help-faq-item" onclick="frToggleFaq(this)">
          ...
          <div class="fr-help-faq-a">Sim! Na etapa "Personalize seu perfil" você pode escolher um nome de exibição diferente. Esse será o nome visto pela modelo — seu nome real é usado apenas para verificação interna.
            <button class="fr-help-back-btn" onclick="frCloseHelp(null, true)">Voltar para verificação</button>
          </div>
        </div>
        <div class="fr-help-faq-item" onclick="frToggleFaq(this)">
          ...
          <div class="fr-help-faq-a">Reprovações geralmente ocorrem por dados incorretos ou documentos ilegíveis. Revise as informações, certifique-se de usar fotos nítidas e tente novamente. Em caso de dúvida, entre em contato com nosso suporte.
            <button class="fr-help-back-btn" onclick="frCloseHelp(null, true)">Voltar para verificação</button>
          </div>
        </div>
      </div>
...
function frValidateStep1() {
  ...
  if(!FR_CPF_REGEX.test(cpf) || !frValidateCPF(cpf)) {
    frShowErr('frCpf','CPF inválido. Verifique os dados e tente novamente.');
    valid = false;
  } else {
    frClearErr('frCpf');
  }
...
// ===== HELP CENTER =====
function frOpenHelp() {
  document.getElementById('frHelpOverlay').classList.add('show');
}

function frCloseHelp(e, force) {
  if(force || !e || e.target === document.getElementById('frHelpOverlay')) {
    document.getElementById('frHelpOverlay').classList.remove('show');
    // Also close contact if open
