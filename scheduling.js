...
<div class="fr-wrap">
  <div class="fr-card" id="frCard">
    ...
    <div class="fr-step" id="frStepMessage">
      <div class="fr-h1">Toque pessoal ✨</div>
      ...
      <div class="fr-msg-chips" id="frMsgChips">
        <button class="fr-msg-chip" onclick="frToggleMsgChip(this)">Lingerie</button>
        ...
        <button class="fr-msg-chip" onclick="frToggleMsgChip(this)">All black</button>
      </div>
...
function frSendMessage() {
  ...
  const chips = Array.from(document.querySelectorAll('.fr-msg-chip.selected')).map(c => c.textContent);
