...
document.body.innerHTML = `
  <div class="container" style="opacity: 0; animation: fadeIn 0.8s ease forwards;">
    ...
    <div id="step6" class="step">
      ...
      <div class="resumo-card">
        <div class="resumo-item"><span>Experiência completa para:</span><span id="resumo-nome"></span></div>
      </div>
  ...
  <div class="premium-overlay" id="premium-overlay">
    <div class="premium-content">
      ...
      <p>Por ser um usuário Premium, você poderá contar com hospedagem inclusa no seu agendamento.</p>
...
function showStep(step) {
  ...
  window.scrollTo(0, 0);
  if (step === 6) {
    const firstName = userData.personal?.nome?.split(' ')[0] || 'Usuário';
