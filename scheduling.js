    ...
    <div id="step5" class="step">
      ...
      <div class="comunicado-card">
        ...
        <div class="hotel-info">
          <div class="hotel-name">A experiência Frame.</div>
          <p class="hotel-desc">Clique no botão "Buscar cidade" e digite a cidade onde deseja a realização do seu encontro ou selecione "Minha cidade não está na lista" e siga os passos indicados na tela.</p>
        </div>
