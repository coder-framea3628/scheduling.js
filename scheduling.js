...
function frStep2Next() {
  ...
  if(frCheckProhibited(dn)) {
    ...
    if(frState.warningCount>=3) {
      frShowWarning('Aviso de uso inadequado','Foram detectadas palavras inadequadas repetidamente. Continuar desta forma poderá resultar no bloqueio temporário de sua conta.');
    }
    return;
  }
